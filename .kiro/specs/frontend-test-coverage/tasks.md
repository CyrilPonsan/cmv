...
- [ ] 2. Implémenter les tests du composable useHttp
  ...
  - [ ]* 2.2 Écrire le test property-based pour la transition isLoading
    - **Propriété 1 : Transition isLoading sur requête réussie**
    - **Valide : Exigences 1.1**

  - [ ]* 2.3 Écrire le test property-based pour la redirection sur erreur serveur
    - **Propriété 2 : Redirection sur erreur serveur (status >= 500)**
    - **Valide : Exigences 1.2**

  - [ ]* 2.4 Écrire le test property-based pour la capture du message d'erreur
...
- [ ] 3. Implémenter les tests du composable useLazyLoad
  ...
  - [ ]* 3.2 Écrire le test property-based pour la mise à jour de lazyState par pagination
    - **Propriété 4 : Mise à jour de lazyState par pagination**
    - **Valide : Exigences 2.2**

  - [ ]* 3.3 Écrire le test property-based pour la réinitialisation de first lors du tri
    - **Propriété 5 : Réinitialisation de first lors du tri**
    - **Valide : Exigences 2.3**

  - [ ]* 3.4 Écrire le test property-based pour la construction des paramètres URL
...
- [ ] 4. Implémenter les tests du composable useChambresList
  ...
  - [ ]* 4.2 Écrire le test property-based pour le filtrage par préfixe des services
...
- [ ] 5. Implémenter les tests du composable useListPatients
  ...
  - [ ]* 5.2 Écrire le test property-based pour showDeleteDialog
...
- [ ] 6. Implémenter les tests des composables usePatient et usePatientForm
  ...
  - [ ]* 6.2 Écrire le test property-based pour la construction de l'URL fetchPatientData
  ...
  - [ ]* 6.4 Écrire le test property-based pour le formatage de la date à midi
...
- [ ] 8. Implémenter les tests des composables useDocuments, useDocumentManagement et useUploadDocument
  ...
  - [ ]* 8.2 Écrire le test property-based pour l'idempotence du double toggle
  ...
  - [ ]* 8.4 Écrire le test property-based pour la construction de l'URL de suppression
  ...
  - [ ]* 8.6 Écrire le test property-based pour la validité du formulaire d'upload
...
- [ ] 13. Implémenter les tests du routeur
  ...
  - [ ]* 13.2 Écrire le test property-based pour les routes inexistantes
    - **Propriété 14 : Routes inexistantes affichent NotFound**
    - **Valide : Exigences 14.4**

  - [ ]* 13.3 Écrire le test property-based pour l'accès aux chambres par rôle
...
- [ ] 14. Implémenter les tests des utilitaires regex
  ...
  - [ ]* 14.2 Écrire le test property-based pour la validation regex email
    - **Propriété 16 : Validation regex email**
    - **Valide : Exigences 15.1**

  - [ ]* 14.3 Écrire le test property-based pour la validation regex mot de passe
    - **Propriété 17 : Validation regex mot de passe**
    - **Valide : Exigences 15.2**

  - [ ]* 14.4 Écrire le test property-based pour la validation regex générique
