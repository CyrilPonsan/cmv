...
from app.sql.models import Civilite  # Import your enum
...
def upgrade() -> None:
    ...
    # Créer le nouveau type enum avec les valeurs mises à jour
    op.execute("CREATE TYPE civilite AS ENUM " + str(tuple(e.value for e in Civilite)))
