...
Revision ID: d27c5619a407
Revises: 42c93718ded3
Create Date: 2026-01-16 22:15:51.110488
...
revision: str = 'd27c5619a407'
down_revision: Union[str, None] = '42c93718ded3'
...
def upgrade() -> None:
    ...
    sa.Column('ref_reservation', sa.Integer(), nullable=True),
    sa.Column('nom_chambre', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
